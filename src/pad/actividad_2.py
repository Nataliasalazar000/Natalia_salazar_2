...
plt.colorbar()
guardar_imagen("punto_14.png")

# Punto 15
plt.contourf(x_grid, y_grid, z_grid, cmap='coolwarm')
plt.colorbar()
guardar_imagen("punto_15.png")
...
plt.legend()
guardar_imagen("punto_16.png")

# Punto 17
data_hist = np.random.randn(1000)
plt.hist(data_hist, bins=30, alpha=0.7)
guardar_imagen("punto_17.png")
